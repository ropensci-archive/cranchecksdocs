...
```{r, results="asis"}
args <- c("https://cranchecks.info/notifications/rules", "-H", paste0('"Authorization: Bearer ', token, '"'))
get_and_show(args)
```
...
```{r, results="asis"}
args <- c("-H", paste0('"Authorization: Bearer ', token, '"'), "\\\n", paste0("https://cranchecks.info/notifications/rules/", rule_id))
get_and_show(args)
```
...
```{r, results="asis"}
args <- c("-XDELETE", "-H", paste0('"Authorization: Bearer ', token, '"'), "\\\n", paste0("https://cranchecks.info/notifications/rules/", rule_id))
get_and_show(args)
```
